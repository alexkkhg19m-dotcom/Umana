...
// Ejecutar desde la raíz del repositorio: node .github/scripts/generate-sitemap.js
...
const posts = JSON.parse(fs.readFileSync(path.join(repoRoot, 'posts.json'), 'utf8'));
...
console.log(
  `✅ sitemap.xml generado: ${posts.length} artículos + ${staticPages.length} páginas = ${allEntries.length} URLs en total`
);
